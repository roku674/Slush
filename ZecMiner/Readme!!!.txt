...
-i	mining intensity. Possible values: 0...8. 0 - lowest intensity and CPU usage, 8 - maximal intensity. You can also specify values for every card, for example "-i 2,5,6". Default value is "6".
